...
export const athletes: Athlete[] = [
  {
    ...
    nextCompetition: "Campeonato Nacional 2024",
    coach: "Miguel Hernández",
    federation: "Federación Mexicana de Natación",
    ranking: 3,
    bio: "Laura García es una nadadora especializada en estilo libre y mariposa. Ha representado a México en múltiples competencias internacionales desde 2018.",
    stats: {
      strength: 85,
      speed: 92,
      endurance: 88,
    ...
    recentResults: [
      ...
      {
        competition: "Copa Latina",
        date: "2023-04-05",
        position: 2,
        result: "54.12s",
      },
    ],
    trainingCenter: "Centro Acuático Olímpico",
    weight: 62,
    height: 175,
  },
  {
    ...
    nextCompetition: "Diamond League 2024",
    coach: "Roberto Méndez",
    federation: "Federación Colombiana de Atletismo",
    ranking: 5,
    bio: "Carlos Santos es un atleta especializado en 400m planos. Ha sido medallista en múltiples competencias internacionales y actualmente se prepara para los Juegos Olímpicos.",
    stats: {
      strength: 88,
      speed: 94,
      endurance: 90,
    ...
    recentResults: [
      ...
      {
        competition: "Diamond League París",
        date: "2023-06-10",
        position: 2,
        result: "44.32s",
      },
    ...
    trainingCenter: "Centro de Alto Rendimiento Bogotá",
    weight: 75,
    height: 183,
  },
  {
    ...
    nextCompetition: "Copa del Mundo 2024",
    coach: "Claudia Fernández",
    federation: "Federación Argentina de Gimnasia",
    ranking: 2,
    bio: "Ana Martinez es una gimnasta artística especializada en barras asimétricas y suelo. Ha sido campeona panamericana y finalista mundial en múltiples ocasiones.",
    stats: {
      strength: 86,
      speed: 88,
      endurance: 84,
    ...
    recentResults: [
      ...
      {
        competition: "Copa del Mundo Stuttgart",
        date: "2023-03-20",
        position: 3,
        result: "56.900 pts",
      },
    ],
    trainingCenter: "Centro Nacional de Alto Rendimiento",
    weight: 52,
    height: 158,
  },
  {
    ...
    nextCompetition: "Vuelta a España 2024",
    coach: "Javier Mínguez",
    federation: "Real Federación Española de Ciclismo",
    ranking: 8,
    bio: "Daniel Lopez es un ciclista especializado en contrarreloj y pruebas de ruta. Actualmente se recupera de una lesión en la rodilla pero espera volver a competir pronto.",
    stats: {
      strength: 90,
      speed: 87,
      endurance: 95,
    ...
    recentResults: [
      ...
      {
        competition: "Mundial Contrarreloj",
        date: "2022-09-25",
        position: 4,
        result: "49:05",
      },
    ],
    trainingCenter: "Centro de Alto Rendimiento Sierra Nevada",
    weight: 68,
    height: 178,
  },
  {
    ...
    nextCompetition: "Australian Open 2024",
    coach: "Marcelo Ríos",
    federation: "Federación de Tenis de Chile",
    ranking: 12,
    bio: "David Gomez es un tenista profesional que ha ascendido rápidamente en el ranking ATP. Su mejor superficie es la tierra batida y ha alcanzado semifinales en Roland Garros.",
    stats: {
      strength: 82,
      speed: 88,
      endurance: 90,
    ...
    recentResults: [
      ...
      {
        competition: "Masters 1000 Madrid",
        date: "2023-05-07",
        position: 5,
        result: "Cuartos de Final",
      },
    ],
    trainingCenter: "Centro de Entrenamiento Olímpico",
    weight: 75,
    height: 185,
  },
  {
    ...
    nextCompetition: "Campeonato Sudamericano 2024",
    coach: "Fernando Alonso",
    federation: "Confederación Argentina de Deportes Acuáticos",
    ranking: 7,
    bio: "Juan Pérez es un nadador especializado en estilo espalda. Ha representado a Argentina en competencias internacionales desde 2019 y es una promesa para los próximos Juegos Olímpicos.",
    stats: {
      strength: 80,
      speed: 85,
      endurance: 90,
    ...
    trainingCenter: "CENARD Buenos Aires",
    weight: 78,
    height: 188,
  },
  {
    ...
    federation: "Federación Mexicana de Atletismo",
    ranking: 4,
    ...
    recentResults: [
      {
        competition: "Diamond League Doha",
        date: "2023-05-05",
        position: 2,
        result: "8.28m",
      },
      {
        competition: "Mundial Indoor",
        date: "2023-03-18",
        position: 1,
        result: "8.35m",
      },
      {
        competition: "Meeting de Madrid",
        date: "2023-02-22",
        position: 1,
        result: "8.22m",
      },
    ],
    trainingCenter: "Centro Deportivo Olímpico Mexicano",
    weight: 75,
    height: 182,
  },
  {
    ...
    federation: "Confederación Brasileña de Gimnasia",
    ranking: 6,
    bio: "Luis Rodríguez es un gimnasta artístico especializado en barras paralelas y caballo con arcos. Ha representado a Brasil en los últimos Juegos Olímpicos y es medallista mundial.",
    stats: {
      strength: 90,
      speed: 85,
      endurance: 87,
    ...
    recentResults: [
      ...
      {
        competition: "Copa del Mundo París",
        date: "2023-04-15",
        position: 2,
        result: "85.900 pts",
      },
    ],
    trainingCenter: "Centro de Excelencia de Gimnasia",
    weight: 65,
    height: 168,
  },
  {
    ...
    personalBest: "Montaña: Etapa Reina Vuelta a Colombia",
    nextCompetition: "Por confirmar",
    coach: "Rigoberto Urán",
    federation: "Federación Colombiana de Ciclismo",
    ranking: 15,
    ...
    recentResults: [
      ...
      {
        competition: "Vuelta a Cataluña",
        date: "2023-03-26",
        position: 5,
        result: "General",
      },
    ],
    trainingCenter: "Centro de Alto Rendimiento en Altura",
    weight: 63,
    height: 175,
  },
  {
    ...
    nextCompetition: "Campeonato Europeo 2024",
    coach: "Antonio Serrano",
    federation: "Real Federación Española de Atletismo",
    ranking: 4,
    bio: "María González es una atleta de medio fondo especializada en 800m. Ha sido campeona europea y finalista mundial, con aspiraciones olímpicas para la próxima cita.",
    stats: {
      strength: 84,
      speed: 90,
      endurance: 93,
    ...
    recentResults: [
      ...
      {
        competition: "Diamond League Londres",
        date: "2023-07-15",
        position: 2,
        result: "1:58.24",
      },
      {
        competition: "Campeonato Europeo",
        date: "2023-06-10",
        position: 1,
        result: "1:59.02",
      },
    ],
    trainingCenter: "Centro de Alto Rendimiento Madrid",
    weight: 54,
    height: 168,
  },
]
