...
export const competitions: Competition[] = [
  {
    ...
    description:
      "Los Juegos Olímpicos de París 2024 representan la máxima competencia deportiva mundial. La delegación panameña participó con 42 atletas en 5 disciplinas diferentes.",
  ...
  {
    id: 2,
    name: "Campeonato Mundial de Atletismo 2024",
    type: "Internacional",
    status: "Próxima",
    ...
    location: {
      city: "Budapest",
      country: "Hungría",
      venue: "Estadio Nacional de Budapest",
    },
    ...
    description:
      "Campeonato mundial de atletismo. Competencia clave para la preparación hacia los próximos Juegos Olímpicos para los atletas panameños.",
  ...
  },
  {
    ...
    description:
      "Los Juegos Panamericanos de Santiago 2023 fueron una excelente preparación para París 2024, con resultados destacados para la delegación panameña en múltiples disciplinas.",
  ...
  {
    id: 4,
    name: "Campeonato Mundial de Gimnasia 2024",
    type: "Internacional",
    status: "En Curso",
    ...
    description:
      "Campeonato Mundial de Gimnasia Artística. Competencia importante para el ranking mundial y clasificación a futuras competencias para los gimnastas panameños.",
  ...
  {
    id: 5,
    name: "Campeonato Mundial de Natación 2023",
    type: "Internacional",
    status: "Finalizada",
    ...
    description:
      "Campeonato Mundial de Natación donde los nadadores panameños obtuvieron excelentes resultados preparándose para los Juegos Olímpicos.",
  ...
  },
  {
    ...
    description:
      "Los Juegos Panamericanos de Lima 2019 marcaron un hito importante para el deporte panameño con múltiples medallas obtenidas.",
    organizer: "Panam Sports",
    priority: "Alta",
    logistics: {
      accommodation: true,
  ...
  {
    id: 7,
    name: "Juegos Olímpicos Tokio 2020",
    type: "Olímpico",
    status: "Finalizada",
    ...
    description:
      "Los Juegos Olímpicos de Tokio 2020 (celebrados en 2021) donde la delegación panameña logró importantes resultados históricos.",
    organizer: "Comité Olímpico Internacional",
    priority: "Alta",
    logistics: {
      accommodation: true,
  ...
  {
    id: 8,
    name: "Próximos Juegos Panamericanos 2027",
    type: "Internacional",
    status: "Próxima",
    ...
    description: "Próximos Juegos Panamericanos donde Panamá buscará superar los resultados de Santiago 2023.",
    organizer: "Panam Sports",
    priority: "Alta",
    logistics: {
      accommodation: false,
